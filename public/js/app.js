...
async function openScript(scriptPath) {
  try {
    ...
    document.getElementById('currentEditingFile').innerText = `Editing: ${scriptPath}`;
...
async function createNewScript() {
  const fileName = prompt('Enter new Lua script name or path (e.g. commands/custom_cmd.lua or my_event.lua):');
